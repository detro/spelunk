...
require (
	...
	github.com/detro/spelunk/plugin/modifier/jsonpath/v2 v2.2.1
	github.com/detro/spelunk/plugin/modifier/tomlpath/v2 v2.2.1
	github.com/detro/spelunk/plugin/modifier/xpath/v2 v2.2.1
	github.com/detro/spelunk/plugin/modifier/yamlpath/v2 v2.2.1
	github.com/detro/spelunk/plugin/source/1password/v2 v2.2.1
	github.com/detro/spelunk/plugin/source/aws/v2 v2.2.1
